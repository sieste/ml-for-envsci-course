...
# load dataset
csv_path = "data/AirQualityUCI.csv"
...
# remove rows where any features or targets are missing
...
# can call model.fit again to continue training if needed

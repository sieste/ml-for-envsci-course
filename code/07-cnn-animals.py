...
# # The commented code below generates the butterfly/chicken/elephant data used in the
# # course lecture. You can adapt the code to create your own training data.
# #
